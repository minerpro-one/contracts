...
contract FILSTToken is ERC20Pausable {
    address factory;
    address _operator;
    address _pauser;
    uint256 private constant _preMineSupply = 5000000 * 1e18;   //预先发放量5000000枚
    uint256 private constant _maxSupply = 20000000 * 1e18;     //总量20000000枚
